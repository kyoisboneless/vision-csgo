...
#include "../cheats/setup-matrix/setup_bones.h"
...
void entity_t::set_model_index(int index)
{
	...
	return call_virtual<Fn>(this, 75)(this, index);
}
...
bool entity_t::compute_hitbox_surrounding_box(Vector* mins, Vector* maxs)
{
	...
	static auto fn = reinterpret_cast<Fn>(util::FindSignature(crypt_str("client.dll"), crypt_str("E9 ? ? ? ? 32 C0 5D")));
...
weapon_info_t* weapon_t::get_csweapon_info()
{
	...
	return call_virtual<Fn>(this, 460)(this);
}
...
float weapon_t::get_inaccuracy()
{
	...
	return call_virtual<float(__thiscall*)(void*)>(this, 482)(this);
}
...
float weapon_t::get_spread()
{
	...
	return call_virtual<float(__thiscall*)(void*)>(this, 452)(this);
}
...
void weapon_t::update_accuracy_penality()
{
	...
	call_virtual<void(__thiscall*)(void*)>(this, 483)(this);
}
...
void player_t::modify_eye_position(Vector& eye_position)
{
	...
	if (eye_position.z > head_position.z) {
		float v13 = 0.f;
		float v3 = eye_position.z - head_position.z;

		float v4 = (v3 - 4.f) * 0.16666667;
		if (v4 >= 0.f)
			v13 = std::fminf(v4, 1.f);

		eye_position.z = (((head_position.z - eye_position.z)) * (((v13 * v13) * 3.0) - (((v13 * v13) * 2.0) * v13))) + eye_position.z;
	}
}
...
void viewmodel_t::SendViewModelMatchingSequence(int sequence)
{
	...
	call_virtual <Fn>(this, 246)(this, sequence);
}
