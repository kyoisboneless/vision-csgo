...
namespace hooks
{
	...
	using EmitSound_t = void(__thiscall*)(void*, IRecipientFilter&, int, int, const char*, unsigned int, const char*, float, int, float, int, int, const Vector*, const Vector*, void*, bool, float, int speakerentity, int);
	...
	using BuildTransformationsFn = void(__thiscall*)(player_t*, studiohdr_t*, Vector*, Quaternion*, const matrix3x4_t&, int, byte*);
	...
	// hooked funcs.
	void __fastcall process_packet(void* edx, void* ecx, void* packet, bool header);
	...
	void __fastcall hooked_emitsound(void* ecx, void* edx, IRecipientFilter& filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample, float flVolume, int nSeed, float flAttenuation, int iFlags, int iPitch, const Vector* pOrigin, const Vector* pDirection, void* pUtlVecOrigins, bool bUpdatePositions, float soundtime, int speakerentity, int unk);
	...
	_declspec(noinline)void buildtransformations_detour(player_t* player, studiohdr_t* hdr, Vector* pos, Quaternion* q, const matrix3x4_t& cameraTransform, int boneMask, byte* boneComputed);
	void __fastcall hooked_buildtransformations(player_t* player, void* edx, studiohdr_t* hdr, Vector* pos, Quaternion* q, const matrix3x4_t& cameraTransform, int boneMask, byte* boneComputed);
