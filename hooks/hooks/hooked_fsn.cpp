...
Vector flb_aim_punch, flb_view_punch;
Vector *aim_punch, *view_punch;
...
void __stdcall hooks::hooked_fsn(ClientFrameStage_t stage) {
	...
	if (g_ctx.globals.updating_skins && m_clientstate()->m_nDeltaTick > 0) //-V807
